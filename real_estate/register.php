                        ...
                        <form  name="reg" action="insert.php" method="post" enctype="multipart/form-data">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Username" id="username" name="username" type="text" value="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Birthday" id="birthday" name="birthday" type="date" value="">
                                </div>
                                <div class="form-group">
                                    <label>Gender:</label>
                                    <br>
                                ...
                                <div class="form-group">
                                    <label>Phone:</label>
                                    <input class="form-control" placeholder="Phone" id="phone" name="phone" type="text" value="">
                                </div>
